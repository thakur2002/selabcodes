...
int CalculateCBO() const {
        // This is a simplistic approach; in a real-world scenario, you would need to analyze the code more comprehensively
        int cbo = 0;

        // Count the number of classes that SnakeGame interacts with
        cbo++;  // Example: SnakeGame interacts with ExternalInteraction
...
int main() {
    ...
    // Calculate and display Coupling Between Classes
    
    int cbo = snakeGame.CalculateCBO();
    std::cout << "Coupling Between Objects (CBO) for SnakeGame: " << cbo << std::endl;

    return 0;
}
//  OUTPUT:

// Coupling Between Objects (CBO) for SnakeGame: 1
